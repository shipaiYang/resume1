...
alter table user_info add constraint FK_Reference_4 foreign key (work_status)
      references work_status (id) on delete restrict on update restrict;
